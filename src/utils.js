...
export const ACCOUNT_CATS = [
  {
    ...
    rendMidden: 0.025, // wordt vervangen door live rente indien beschikbaar
  ...
  {
    id: "overig",
    label: "Overig / eigen invullen",
    emoji: "💼",
    uitleg: "Overwaarde woning, bedrijfsaandelen, of een ander type vermogen. Vul zelf het rendement in.",
    rendMidden: 0.04,
    rendBand: [0.00, 0.10],
    kleur: "#9a8060",
  },
